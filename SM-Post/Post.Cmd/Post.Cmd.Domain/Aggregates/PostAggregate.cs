...
public class PostAggregate : AggregateRoot
{
  ...
  public void EditComment(Guid commentId, string comment, string username)
  {
    ...
    if (!_comments.ContainsKey(commentId) || !_comments[commentId].Item2.Equals(username, StringComparison.OrdinalIgnoreCase))
    {
  ...
  public void DeletePost(string username)
  {
    ...
    if (_author == null || !_author.Equals(username, StringComparison.CurrentCultureIgnoreCase))
    {
